...
class ControllerSpec extends WordSpec with Matchers {
    "A controller" should {
        ...
        val fields = List(ActionField("Go"), Street("street1", 50, Array(1,2,3,4,5), houseCost = 25))
        var player1 = Player("player1", 1500, fields.head, Set(), new FieldIterator(fields))
        var player2 = Player("player2", 1500, fields.head, Set(), new FieldIterator(fields))
